...
--     psql -h <host> -U <user> -d <database> -f all_cities_058_082_combined.sql
--
--   Option 3 - Use the include-based version:
--     psql -h <host> -U <user> -d <database> -f run_phases_12_16_complete.sql
--
-- CONTENTS:
...
--
-- Each city includes:
--   - City record (name, location, demographics)
--   - City research data (population, climate, utilities)
--   - 6-8 Neighborhoods with detailed characteristics
--   - SEO content (marketing copy, FAQs, services)
--
-- All INSERT statements use ON CONFLICT clauses for safe re-execution
-- ============================================================================
